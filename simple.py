...
dic['reference'] = '可参考数据集%s'%source_path  # 参考
dic['licence'] = '20220704'
dic['release'] = '0.0'  # 不知道是什么但不重要
dic['modality'] = {'0': 'CT', }
dic['labels'] = {'0': 'background', '1': 'VESSEL', }  # 血管
# （修改区停）-----------
...
if to_setting:
    ...
    save_00 = r'E:\dataset\nnUNet_raw_data_base\nnUNet_raw_data\Task10_VESSEL'  # （例）
print('3 setting down!')
